...
export const metadata: Metadata = {
  title: "Get Custom Website | Ueni - Professional Web Design & Development",
  description:
  ...
  alternates: {
    canonical: "https://ueniagency.com/get-custom-website",
  },
  openGraph: {
    title: "Get Custom Website | Ueni - Professional Web Design & Development",
    description:
...
export default function DoneForYouWebsitePage() {
  return (
    <PageTransition>
      <main className="custom-website-page min-h-screen bg-[radial-gradient(70%_120%_at_50%_-10%,rgba(147,51,234,0.35)_0%,rgba(147,51,234,0)_62%),radial-gradient(68%_58%_at_50%_62%,rgba(126,34,206,0.55)_0%,rgba(126,34,206,0)_72%),linear-gradient(180deg,#5b21b6_0%,#7c3aed_42%,#a855f7_62%,#5b21b6_82%,#1a1a2e_100%)]">
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-slate-600 mb-4">Discover our story, mission, and why businesses trust Ueni for their web solutions.</p>
            </div>
          </div>
          ...
          <div className="mt-12 p-8 bg-white rounded-lg border-l-4 border-blue-600">
            ...
            <p className="text-slate-600 mb-4">We also offer <a href="https://ueniagency.com/get-wordpress-website" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">WordPress website development</a> for those who prefer open-source solutions.</p>
          </div>
        </div>
      </section>
