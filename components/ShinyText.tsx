...
export function ShinyText({
  ...
  shineWidth = 30, // Default to a reasonable shine width
  delay = 0,
  repeat = "infinite",
  pauseOnHover = false,
  gradientType = "linear",
  ...
  // Default colors: baseColor should be translucent white for hero text, shineColor should be bright white
  const defaultBaseColor = "rgba(255, 255, 255, 0.45)";
  const defaultShineColor = "rgba(255, 255, 255, 1)";
  ...
  const createGradient = () => {
    ...
    return gradientType === "linear"
      ? `linear-gradient(${gradientDirection}, ${finalBaseColor}, ${finalBaseColor} ${transparentStartPos - 15}%, ${shineStart}, ${shineEnd}, ${finalBaseColor} ${transparentEndPos + 15}%, ${finalBaseColor})`
