...
export default function ProfessionalWebSectionCopy({
    ...
    return (
        <section
            ...
            style={{
                background: "linear-gradient(120deg, #06281e 0%, #0e5f46 45%, #10b981 100%)",
            }}
        >
            <style>{`
        @keyframes pro-shine {
      ...
      `}</style>
            ...
            <FadeIn>
              ...
              ${centered
                                    ...
                                    : "max-w-[520px] text-[20px] leading-[31px]"
                                }
              max-[960px]:text-[20px]
              ...
              max-[640px]:leading-[22px]`}
                        >
                              And our team to help you, every step of the way.
